 ...
 * @author tatuapu
 */
@WebServlet(name = "contests", urlPatterns = {"/contests"})
public class ServletContests extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(cmd.equalsIgnoreCase("listar")){
                List contestList = dao.listaTodos();//recebendo o ArrayList com todos autores
                request.setAttribute("contestList", contestList);//enviando parâmetros via request
                //setando o despachador
                rd = request.getRequestDispatcher("contests.jsp");
