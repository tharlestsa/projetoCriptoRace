 ...
 * @author tatuapu
 */
@WebServlet(urlPatterns = {"/controlador.pvh"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(cmd.equalsIgnoreCase("ranking")){
                List rankingList = dao.ranking();//recebendo o ArrayList com o ranking
                request.setAttribute("rankingList", rankingList);//enviando parâmetros via request
